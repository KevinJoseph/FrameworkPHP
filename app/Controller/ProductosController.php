...
class ProductosController extends AppController {
    ...
    public function edit($id = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->Producto->save($this->request->data)) {
                ...
                $this->Session->setFlash('No se ha podido actualizar esa Marca');
            }
        } else {
            $this->request->data = $this->Producto->find('first', array('conditions' => array('Producto.id' => $id)));
        }
        $this->set('marca',$this->Producto->Marca->find('list'));
    }
    ...
    public function delete($id = null) {
        ...
        if ($this->Producto->delete()) {
            ...
            $this->Session->setFlash('No se ha podido eliminar ese marca.');
        }
        return $this->redirect(array('action' => 'index'));
    }
